...
m = 707906040533962153
c = encrypt(pub, m)
m_prime = decrypt(priv, pub, c)

print("The clear message is m = ", m)
print("The cipher text is c = E(m) = ", c)
print("The decryption of the cipher text is m' = D(c) = ", m_prime)
